...
def get_latest_model():
    model_files = glob.glob('model_weights_*.pth')
...
def test_model_architecture():
    ...
    assert total_params < 3000000, f"Model has {total_params} parameters, should be < 100000"
...
def test_model_accuracy():
    ...
    assert model_path is not None, "No model weights found"
